...
- **Modular Addons**: Optional complex features like Personal Context are built in an isolated `modules/` folder with minimal integration hooks in `main.py` and `app.py`. They bring their own storage and UI logic while reusing core providers.
...
- `modules/`: Fully isolated addons (Personal Context) that are injected into the core UI.
...
- **[2026-06-04]**: Implemented Personal Context System module as an isolated addon. Added DOCX/PDF parsing.
